...
const s3Client = new S3Client({
  region: REGION,
  // In development, use credentials from ~/.aws/credentials
  // In production, let SDK use IAM role credentials automatically
  ...(isDev ? {
    credentials: fromIni({
    ...
    // In production, we don't specify credentials to let SDK use IAM role
    // The Amplify app needs the appropriate IAM role with S3 permissions
